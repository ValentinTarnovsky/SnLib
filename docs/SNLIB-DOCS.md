...
- INTERACT ACTIONS (mundo, no GUI): 8 listas: `right-click-actions`, `left-click-actions`, `shift-right-click-actions`, `shift-left-click-actions`, `right-click-block-actions`, `right-click-air-actions`, `left-click-block-actions`, `left-click-air-actions`. Ademas de las acciones comunes suma `[particle] TYPE x y z offX offY offZ speed count`, `[potion] EFFECT duration(ticks) amplifier`, `[remove-item]` (1 unidad) y `[remove-item] N`.
